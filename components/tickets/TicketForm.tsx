...
export default function TicketForm({ initial, onSubmit, onCancel }: TicketFormProps) {
  ...
  const inputClass = 'w-full rounded-xl border border-gray-200 px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-shadow';
